                ...
                GetUploadPendingList != undefined ? GetUploadPendingList.map((item, index) => {
                    ...
                    return <tr key={index}>
                        ...
                        <td className="pt-4 d-flex text-capitalize">{item.defaulterEntry.debtor.companyName}
                            <br />
                            {item.defaulterEntry.debtor.address1} {item.defaulterEntry.debtor.address2 == undefined ? '' : item.defaulterEntry.debtor.address2 + ', '} {item.defaulterEntry.debtor.city}, {item.defaulterEntry.debtor.state} </td>
