...
export const SalesOrderModule = props => {
    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                filterable: false,
                Cell: cellProps => {
                    return <div className="text-capitalize"><span style={{ color: checkColor(cellProps.cell.row.original?.status) }}>
    ...
    return (
        <React.Fragment>
            {viewModuleOpen && <ViewDetailsOrderManagementModal isOpen={viewModuleOpen} toggle={toggleViewModuleOpen} viewModalData={viewModalData} name={'Buyer'} />}
