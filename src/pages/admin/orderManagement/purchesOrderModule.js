  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        Cell: cellProps => {
          return (
            <div className="text-capitalize" style={{ width: "150px" }}>
              <span
                style={{
  ...
  return (
    <React.Fragment>
      {deletePop && (
        <InvoiceDeletePop
          isOpen={deletePop}
          toggle={toggleDeletePop}
          deleteValue={deleteValue}
          DeleteInvoiceModule={DeleteInvoiceModule}
        />
      )}
      {modal2 && (
        <ReportedDefaulterModel
          isOpen={modal2}
          toggle={toggleViewModal1}
          selected={selected}
          customerName={invoiceIdsForCAcertificate}
          requestor={"CREDITOR"}
          name={"Buyer"}
        />
      )}
      {selectCACertificate && (
        <UploadCACertificateModel
          isOpen={selectCACertificate}
          toggle={toggleViewModal2}
          invoiceId={invoiceIdsForCAcertificate}
