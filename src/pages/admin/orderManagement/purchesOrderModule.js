...
import { NewOrderModel } from "./newOrderModule"
...
export const PurchaseOrderModule = props => {
    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                Cell: cellProps => {
                    return <div style={{ width: "80px" }}> {cellProps.cell?.row?.original?.dueFrom}</div>
                },
            },
            {
                Header: "seller NAME",
            ...
            },
            {
                ...
                filterable: false,
                Cell: cellProps => {
                    return <div style={{ width: "", /* textAlign: 'right' */ }}>{cellProps.cell?.row?.original?.totalAmount}</div>
                },
            },
            {
                Header: "Unit",
            ...
            },
            {
                ...
                filterable: false,
                Cell: cellProps => {
                    return <div className="text-capitalize" style={{ width: "150px" }}><span style={{ color: checkColor(cellProps.cell.row.original?.status) }}>
                        {cellProps.cell.row.original?.status}</span></div >
                },
            },
            {
                Header: "ACTION",
    ...
    const checkColor = (text) => {
        if (text === 'Approve') return "green"
        if (text === 'Revise & sent for customer approval') return "blue"
        if (text === 'Reject') return "red"
    }
    ...
    const dummyData = [
        {
            ...
            "creditor": {
                ...
                "companyOwner": {
                    ...
                    "phoneNumber": "9869151229",
                    "secPhoneNumber": "",
                    "password": "$2a$10$PWiFDRMlnbF.7QkhfkPjVOWY85Yza02ypyoeTyQ7iYU05NewmIlBK",
                    "role": "OWNER",
                    ...
                    "permissions": [],
                    "companies": [
                        "6688c0b8a17e2168679a1907",
                        "668fd3733bce4610a48434b6"
                    ],
        ...
        },
        {
            ...
            "status": "Revise & sent for customer approval",
            "dueFrom": "10-07-2024",
            "Address": "90 feet, sakinka, Bamboo Flat, Andaman and Nicobar Islands",
            "totalAmount": 5,
            "creditor": {
        ...
        <React.Fragment>
            ...
            <Card style={{ padding: props.isClickedToOrder != undefined && props.isClickedToOrder ? "0px" : '0px' }}>
                <CardBody style={{ padding: props.isClickedToOrder != undefined && props.isClickedToOrder ? "0px" : '0px' }}>
                    {props.isClickedToOrder == undefined && !props.isClickedToOrder ? <>   <div className="mb-4 h4 card-title"></div>
                        <br />
                        <br />
                        <br />
                    </> : ""}
                    ...
                    <Row>
                        <Col md={10} className="pl-2" style={{ textTransform: "capitalize" }}>
                            {props.isClickedToOrder == undefined && !props.isClickedToOrder ? <h5 className="m-1"><b>My Complaints</b></h5> : ""}
                        </Col>
                        <Col md={2}>

                            <Button className="btn btn-md btn-info" onClick={() => handleReportDefaulter()}>New Order</Button>
